...
const { getAllProdAndImages,getAllProduct, getOneProduct, addProduct, deleteProduct, updateProduct, getAllProductByCategories, getProdAndImage, getImagesForOneProduct} = require('../Controllers/Products.js');
...
productRoute.get("/getprodetails/:id", getImagesForOneProduct)
